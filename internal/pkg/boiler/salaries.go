...
func (q salaryQuery) One(ctx context.Context, exec boil.ContextExecutor) (*Salary, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "boiler: failed to execute a one query for salaries")
	}
...
func (q salaryQuery) All(ctx context.Context, exec boil.ContextExecutor) (SalarySlice, error) {
	...
	err := q.Bind(ctx, exec, &o)
	if err != nil {
		return nil, errors.Wrap(err, "boiler: failed to assign all query results to Salary slice")
	}
...
func (q salaryQuery) Count(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "boiler: failed to count salaries rows")
	}
...
func (q salaryQuery) Exists(ctx context.Context, exec boil.ContextExecutor) (bool, error) {
	...
	err := q.Query.QueryRowContext(ctx, exec).Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "boiler: failed to check if salaries exists")
	}
...
func FindSalary(ctx context.Context, exec boil.ContextExecutor, empNo int, fromDate time.Time, selectCols ...string) (*Salary, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "boiler: unable to select from salaries")
	}
...
func (o *Salary) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	if o == nil {
		return errors.New("boiler: no salaries provided for insertion")
	}
	...
	if err != nil {
		return errors.Wrap(err, "boiler: unable to insert into salaries")
	}
	...
	if err != nil {
		return errors.Wrap(err, "boiler: unable to populate default values for salaries")
	}
...
func (o *Salary) Update(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) (int64, error) {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return 0, errors.New("boiler: unable to update salaries, could not build whitelist")
		}
	...
	if err != nil {
		return 0, errors.Wrap(err, "boiler: unable to update salaries row")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "boiler: failed to get rows affected by update for salaries")
	}
...
func (q salaryQuery) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "boiler: unable to update all for salaries")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "boiler: unable to retrieve rows affected for salaries")
	}
...
func (o SalarySlice) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "boiler: unable to update all in salary slice")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "boiler: unable to retrieve rows affected all in update all salary")
	}
	return rowsAff, nil
}
...
func (o *Salary) Upsert(ctx context.Context, exec boil.ContextExecutor, updateColumns, insertColumns boil.Columns) error {
	if o == nil {
		return errors.New("boiler: no salaries provided for upsert")
	}
	...
	if !cached {
		...
		if !updateColumns.IsNone() && len(update) == 0 {
			return errors.New("boiler: unable to upsert salaries, could not build update column list")
		}
	...
	if err != nil {
		return errors.Wrap(err, "boiler: unable to upsert for salaries")
	}
	...
	if err != nil {
		return errors.Wrap(err, "boiler: unable to retrieve unique values for salaries")
	}
...
func (o *Salary) Delete(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if o == nil {
		return 0, errors.New("boiler: no Salary provided for delete")
	}
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "boiler: unable to delete from salaries")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "boiler: failed to get rows affected by delete for salaries")
	}
...
func (q salaryQuery) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if q.Query == nil {
		return 0, errors.New("boiler: no salaryQuery provided for delete all")
	}
	...
	result, err := q.Query.ExecContext(ctx, exec)
	if err != nil {
		return 0, errors.Wrap(err, "boiler: unable to delete all from salaries")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "boiler: failed to get rows affected by deleteall for salaries")
	}
...
func (o SalarySlice) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "boiler: unable to delete all from salary slice")
	}
...
func (o *SalarySlice) ReloadAll(ctx context.Context, exec boil.ContextExecutor) error {
	...
	if err != nil {
		return errors.Wrap(err, "boiler: unable to reload all in SalarySlice")
	}
...
func SalaryExists(ctx context.Context, exec boil.ContextExecutor, empNo int, fromDate time.Time) (bool, error) {
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "boiler: unable to check if salaries exists")
	}
